...
// Obtener datos de los trabajadores (si corresponde)
// Asegúrate de tener datos correctos en la tabla 'registration'
$worker_loans = array();
$sql = "SELECT id, full_name, mobile_number, worker_id, nickname FROM registration";
...
$client_loans = array();
$sql = "SELECT id, first_name, client_number, loan_type, requested_amount FROM loan_information";
$result = $conn->query($sql);
    ...
    <div class="card info-card customers-card">
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    if (empty($worker_loans)) {
                        echo "<tr><td colspan='5'>No se encontraron trabajadores.</td></tr>";
                    } else {
                        foreach ($worker_loans as $loan) {
                            echo "<tr>";
                            echo "<td>" . htmlspecialchars($loan['id']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['full_name']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['mobile_number']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['worker_id']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['nickname']) . "</td>";
                            echo "</tr>";
                        }
                    }
                    ?>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (empty($client_loans)) {
                        echo "<tr><td colspan='5'>No se encontraron préstamos de clientes.</td></tr>";
                    } else {
                        foreach ($client_loans as $loan) {
                            echo "<tr>";
                            echo "<td>" . htmlspecialchars($loan['id']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['first_name']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['client_number']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['loan_type']) . "</td>";
                            echo "<td>" . htmlspecialchars($loan['requested_amount']) . "</td>";
                            echo "</tr>";
                        }
                    }
                    ?>
